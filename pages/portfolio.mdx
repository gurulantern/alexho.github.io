...
application](https://github.com/gurulantern/sub-finder).  This application uses the Slack API to publish substitution requests for
...
compare them to the amount of times they have already substituted. This feauture was an algorithm designed to choose teachers who
